...
- Teddy bear or faux fur yarn - E.g. [Rico Design Baby Teddy Aran](https://www.lovecrafts.com/en-gb/p/rico-baby-teddy-aran)
...
- I have used [Rico Design's Baby Teddy Aran](https://www.lovecrafts.com/en-gb/p/rico-baby-teddy-aran) yarn and I am very happy with the results! The texture resembles snow and it even sparkles a little in the light! 
...
{({ setState, ...state }) => {
    const calcCO = (gauge, diameter) => {
        ...
        return Math.round(gauge/4 * circumference);
    }
    return (
        <React.Fragment>
        <form>
